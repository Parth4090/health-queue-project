...
import { 
  Eye, EyeOff, User, Lock, Mail, Phone, MapPin
} from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.role === 'doctor') {
        // For doctors, redirect to doctor registration
        ...
        // Use regular registration for patients
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Healthcare Illustration Background */}
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join the Health Queue Management System</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link
                to={formData.role === 'doctor' ? '/doctor/login' : '/patient/login'}
